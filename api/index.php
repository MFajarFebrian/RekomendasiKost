...
// Local XAMPP often has /RekomendasiKost_2/api or /RekomendasiKost/api
// Vercel usually is /api directly
$possibleBasePaths = [
    '/RekomendasiKost_2/api',
    '/RekomendasiKost/api',
    '/api'
];

foreach ($possibleBasePaths as $base) {
